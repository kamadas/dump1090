...
function SetColumnVisibility() {
  ...
  ShowColumn(infoTable, '#civil_mil', !mapIsVisible);	//ver Ka
  ShowColumn(infoTable, '#squawk', !mapIsVisible);	//ver Ka
  ShowColumn(infoTable, '#aircraft_type', !mapIsVisible);
  ShowColumn(infoTable, '#vert_rate', !mapIsVisible);
  ShowColumn(infoTable, '#msgs', !mapIsVisible);	//ver Ka
...
// 'radius' meters
//function MakeGeodesicCircle(center, radius, points) {		//Original ver
export function MakeGeodesicCircle(center, radius, points, sd, ed) {	//vew Ka
...
//    let showAltChart = $('#alt_chart_checkbox').prop('checked');	//Original version
    let showAltChart = false;						//ver Ka
...
//      new ol.control.Attribution({ collapsed: false }),	//Original version
      new ol.control.Attribution({ collapsible: true },
                                 { collapsed: true }),		//ver Ka
...
//            layer_site_pos: true,		//Original version
            layer_site_pos: false,		//ver Ka
            layer_ac_trail: true,
            layer_ac_positions: true,
						//ver Ka start
