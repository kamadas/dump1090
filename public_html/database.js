...
function InitAircrafts() {
  $.ajax({
//    url: `${OnlineDatabaseUrl}db/aircrafts.json`,	//Original version
    url: `${OnlineDatabaseUrl}db/my_aircrafts.json`,	//ver Ka
    cache: false,
    timeout: 0,
    dataType: 'json',
  })
...
function InitOperators() {
  $.ajax({
//    url: `${OnlineDatabaseUrl}db/operators.json`,	//Original version
    url: `${OnlineDatabaseUrl}db/my_operators.json`,	//ver Ka
    cache: false,
    timeout: 0,
    dataType: 'json',
  })
...
export function GetOperator(plane) {
  ...
  const req2 = index.get(plane.flight.substring(0, 2));	//ver Ka
						//ver Ka start
  req2.onsuccess = (e) => {
